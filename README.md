...
ArtistPro/ ├── client/ # Frontend React application 
           └── server/ # Backend Node.js Express application

🔽 Clone the Repository

git clone https://github.com/-dk/artistpro cd artistpro
...
create a cluster mongo db🛠️ MongoDB Setup Guide (Atlas)
📌 1. Create MongoDB Account
Go to MongoDB Atlas:
👉 https://cloud.mongodb.com
Sign up or log in.

📌 2. Open Your Cluster Dashboard
Use your project dashboard:
👉 https://cloud.mongodb.com/v2/6a04c586207c3b588e03f457#/overview

📌 3. Create a Cluster
Click Build a Database
Choose FREE (Shared Cluster)
Select:
Provider: AWS / GCP (any)
...
📧 Gmail App Password Setup (For Sending Emails)
⚠️ Important

Google does not allow normal Gmail password for Node.js apps anymore.
...
Select:
App: Mail
Device: Other (Custom name) → type: Node.js App
Click Generate
...
👉 Official Website: https://www.agentbase.sh
...
Create and manage AI-powered agents
Automate backend tasks using API calls
Handle intelligent workflows and agent execution
Enable scalable AI-driven operations without custom infrastructure
